                        ...
                        <div class="form-group row mt-3">
                            ...
                            <div class="col-md-6">
                                <select id="profession" class="form-control @error('profession_id') is-invalid @enderror" name="profession_id" required>
                                    ...
                                    @empty
                                    <!-- Handle case when there are no professions for the selected department -->
                                    <option value="" disabled>No professions available for the selected department</option>
                                    @endforelse
                                </select>
                                @error('profession_id')
